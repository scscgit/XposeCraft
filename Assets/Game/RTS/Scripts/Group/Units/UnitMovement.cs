                ...
                if (myPath.list.Length > 0)
                {
                    ...
                    if (!skip)
                    {
                        ...
                        Quaternion targetRotation = Quaternion.LookRotation(
                            new Vector3(gridScript.grids[gridI].grid[myPath.list[curPoint]].loc.x, 0,
                        ...
                        float distFromPlace = (new Vector3(gridScript.grids[gridI].grid[myPath.list[curPoint]].loc.x, 0,
                                                   gridScript.grids[gridI].grid[myPath.list[curPoint]].loc.z) -
                                               new Vector3(myTransform.position.x, 0, myTransform.position.z))
                            .sqrMagnitude;
