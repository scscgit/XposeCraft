...
public class FactionEditor : EditorWindow
{
    ...
    void DrawSetup(Vector2 rect)
    {
        ...
        if (target.FactionList.Length * 20 * rect.x < 655 * rect.x)
        {
            groupPosition = GUI.BeginScrollView(new Rect(0, 45 * rect.y, 200 * rect.x, 655 * rect.y), groupPosition,
                new Rect(0, 0, 200 * rect.x, 655 * rect.y), false, true);
        }
        else
        {
            groupPosition = GUI.BeginScrollView(new Rect(0, 45 * rect.y, 200 * rect.x, 655 * rect.y), groupPosition,
        ...
        for (int x = 0; x < target.FactionList.Length; x++)
        {
            ...
            else
            {
                ...
                target.FactionList[x] = EditorGUI.ObjectField(new Rect(0, x * 20 * rect.y, 200 * rect.x, 20 * rect.y),
                    target.FactionList[x], typeof(GameObject), true) as GameObject;
            }
            if (groupId == x)
            {
                GUI.DrawTexture(new Rect(0, x * 20 * rect.y, 200 * rect.x, 20 * rect.y), selectionTexture,
        ...
        if (target.FactionList.Length > 0)
        {
            ...
            else if (target.FactionList[groupId])
            {
                ...
                if (nTarget)
                {
                    if (groupState == 1)
                    {
                        unitSearch = EditorGUI.TextField(new Rect(200 * rect.x, 0, 200 * rect.x, 25 * rect.y),
                            unitSearch);
                        ...
                        if (unitState == 0)
                        {
                            GUI.DrawTexture(new Rect(200 * rect.x, 25 * rect.y, 100 * rect.x, 20 * rect.y),
                                selectionTexture, ScaleMode.StretchToFill);
                            if (nTarget.UnitList.Length * 20 * rect.x < 655 * rect.x)
                            {
                                unitPosition = GUI.BeginScrollView(
                                    new Rect(200 * rect.x, 45 * rect.y, 200 * rect.x, 655 * rect.y), unitPosition,
                            ...
                            for (int x = 0; x < nTarget.UnitList.Length; x++)
                            {
                                if (nTarget.UnitList[x].obj != null)
                                {
                                    ...
                                    if (cont)
                                    {
                                        GUI.Label(new Rect(0 * rect.x, x * 20 * rect.y, 200 * rect.x, 20 * rect.y),
                                            cont.name);
                                    }
                                    else
                                    {
                                ...
                                if (unitId == x)
                                {
                                    GUI.DrawTexture(new Rect(0 * rect.x, x * 20 * rect.y, 200 * rect.x, 20 * rect.y),
                                        selectionTexture, ScaleMode.StretchToFill);
                                }
                            }
                        }
                        ...
                        {
                            GUI.DrawTexture(new Rect(300 * rect.x, 25 * rect.y, 100 * rect.x, 20 * rect.y),
                                selectionTexture, ScaleMode.StretchToFill);
                            ...
                            else
                            {
                                unitPosition = GUI.BeginScrollView(
                                    new Rect(200 * rect.x, 45 * rect.y, 200 * rect.x, 655 * rect.y), unitPosition,
                                    new Rect(0, 0, 200 * rect.x, nTarget.BuildingList.Length * 20 * rect.y), false,
                                    true);
                            }
                            ...
                            for (int x = 0; x < nTarget.BuildingList.Length; x++)
                            {
                                if (nTarget.BuildingList[x].obj != null)
                                {
                                    ...
                                    {
                                        GUI.Label(new Rect(0, x * 20 * rect.y, 200 * rect.x, 20 * rect.y),
                                            "New Building");
                                    }
                                }
                                else
                                ...
                                if (unitId == x)
                                {
                                    GUI.DrawTexture(new Rect(0, x * 20 * rect.y, 200 * rect.x, 20 * rect.y),
                                        selectionTexture, ScaleMode.StretchToFill);
                                }
                            }
                        }
    ...
    void DrawGroupGUI(Vector2 rect)
    {
        ...
        if (menuState == 0)
        {
            GUI.DrawTexture(new Rect(200 * rect.x, 0, 325 * rect.x, 25 * rect.y), selectionTexture,
                ScaleMode.StretchToFill);
            if (groupId < 0)
            {
                groupId = 0;
            ...
            if (target.FactionList.Length > 0)
            {
                if (target.FactionList[groupId] != null)
                {
                    target.FactionList[groupId].name = EditorGUI.TextField(
                        new Rect(200 * rect.x, 95 * rect.y, 1300 * rect.x, 25 * rect.y), "Name : ",
        ...
        {
            GUI.DrawTexture(new Rect(525 * rect.x, 0, 325 * rect.x, 25 * rect.y), selectionTexture,
                ScaleMode.StretchToFill);
            ...
            else
            {
                ...
                else
                {
                    ...
                    arraySelect = EditorGUI.Popup(new Rect(200 * rect.x, 95 * rect.y, 1300 * rect.x, 25 * rect.y),
                        "Faction : ", arraySelect, groupNames);
                    if (arraySelect != selfLocation)
                    {
                        string[] options = {"Ally", "Neutral", "Enemy"};
                        nTarget.Relations[arraySelect].state = EditorGUI.Popup(
                            new Rect(200 * rect.x, 120 * rect.y, 1300 * rect.x, 25 * rect.y), "Relation : ",
                            nTarget.Relations[arraySelect].state, options);
                    }
                    else
                    {
                        helpState = 2;
        ...
        {
            GUI.DrawTexture(new Rect(850 * rect.x, 0, 325 * rect.x, 25 * rect.y), selectionTexture,
                ScaleMode.StretchToFill);
            helpState = 4;
...
//				if (maxY <= 620) {
                groupPosition2 = GUI.BeginScrollView(new Rect(200 * rect.x, 80 * rect.y, 1300 * rect.x, 620 * rect.y),
                    groupPosition2, new Rect(0, 0, 200 * rect.x, 655 * rect.y), false,
                    true);
//				} else {
...
//				}
                ...
                techList = EditorGUI.Popup(new Rect(0 * rect.x, curY * rect.y, 1300 * rect.x, 20 * rect.y), "Tech : ",
                    techList, techName);
                curY += 25;
                techOpen = EditorGUI.Foldout(new Rect(0 * rect.x, curY * rect.y, 1300 * rect.x, 20 * rect.y), techOpen,
                    "Info : ");
                curY += 25;
                if (techOpen)
                {
                    techs[techList].name =
                        EditorGUI.TextField(new Rect(0 * rect.x, curY * rect.y, 1300 * rect.x, 20 * rect.y), "Name : ",
                            techs[techList].name);
                    curY += 25;
                    EditorGUI.LabelField(new Rect(0 * rect.x, curY * rect.y, 1300 * rect.x, 20 * rect.y), "Texture : ");
                    curY += 20;
                    techs[techList].texture =
                        EditorGUI.ObjectField(new Rect(0 * rect.x, curY * rect.y, 100 * rect.x, 100 * rect.y), "",
                            techs[techList].texture, typeof(Texture2D), true) as Texture2D;
                    curY += 80;
                    techs[techList].active =
                        EditorGUI.Toggle(new Rect(0 * rect.x, curY * rect.y, 1300 * rect.x, 20 * rect.y), "Active : ",
                            techs[techList].active);
                    curY += 25;
                }
                GUI.EndScrollView();
        ...
        {
            helpState = 3;
            GUI.DrawTexture(new Rect(1175 * rect.x, 0, 325 * rect.x, 25 * rect.y), selectionTexture,
                ScaleMode.StretchToFill);
            int curY = 95;
            if (target.UnitTypes.Length > 0)
            {
                ...
                curY += 20;
                arraySelect = EditorGUI.Popup(new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y),
                    "Type : ", arraySelect, typeNames);
                curY += 15;
                ...
                target.UnitTypes[arraySelect].name = EditorGUI.TextField(
                    new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y), "Type Name : ",
                ...
                if (target.UnitTypes[arraySelect].strengths.Length > 0)
                {
                    ...
                    {
                        ModifyGTS(target.UnitTypes[arraySelect].strengths.Length + 1,
                            target.UnitTypes[arraySelect].strengths.Length, arraySelect1, arraySelect);
                    }
                    if (GUI.Button(new Rect(850 * rect.x, curY * rect.y, 650 * rect.x, 15 * rect.y),
                        "Remove Strength"))
                    {
                        ModifyGTS(target.UnitTypes[arraySelect].strengths.Length - 1,
                            target.UnitTypes[arraySelect].strengths.Length, arraySelect1, arraySelect);
                    ...
                    curY += 20;
                    arraySelect1 = EditorGUI.Popup(new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y),
                        "Strength : ", arraySelect1, strengthName);
                    curY += 15;
                    ...
                    if (target.UnitTypes[arraySelect].strengths.Length > 0)
                    {
                        target.UnitTypes[arraySelect].strengths[arraySelect1].name = EditorGUI.TextField(
                            new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y), "Name : ",
                        ...
                        target.UnitTypes[arraySelect].strengths[arraySelect1].target = EditorGUI.Popup(
                            new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y), "Target : ",
                            target.UnitTypes[arraySelect].strengths[arraySelect1].target, typeNames);
                        ...
                        target.UnitTypes[arraySelect].strengths[arraySelect1].amount = EditorGUI.FloatField(
                            new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y), "Ratio : ",
                ...
                if (target.UnitTypes[arraySelect].weaknesses.Length > 0)
                {
                    ...
                    {
                        ModifyGTW(target.UnitTypes[arraySelect].weaknesses.Length + 1,
                            target.UnitTypes[arraySelect].weaknesses.Length, arraySelect2, arraySelect);
                    }
                    if (GUI.Button(new Rect(850 * rect.x, curY * rect.y, 650 * rect.x, 15 * rect.y),
                        "Remove Weakness"))
                    {
                    ...
                    curY += 20;
                    arraySelect2 = EditorGUI.Popup(new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y),
                        "Weakness : ", arraySelect2, weaknessName);
                    curY += 15;
                    ...
                    target.UnitTypes[arraySelect].weaknesses[arraySelect2].target = EditorGUI.Popup(
                        new Rect(200 * rect.x, curY * rect.y, 1300 * rect.x, 25 * rect.y), "Target : ",
                        target.UnitTypes[arraySelect].weaknesses[arraySelect2].target, typeNames);
                    curY += 30;
            ...
            else if (nTarget.UnitList.Length > 0)
            {
                if (nTarget.UnitList[unitId].obj)
                {
                    ...
                    if (myTarget)
                    {
                        ...
                        if (menuState == 0)
                        {
                            GUI.DrawTexture(new Rect(400 * rect.x, 0, 275 * rect.x, 25 * rect.y), selectionTexture,
                                ScaleMode.StretchToFill);
                            ...
                            {
                                helpState = 5;
                                GUI.DrawTexture(new Rect(400 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                myTarget.name =
                                    EditorGUI.TextField(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Name : ", myTarget.name);
                                myTarget.maxHealth =
                                    EditorGUI.IntField(new Rect(400 * rect.x, 100 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Max Health : ", myTarget.maxHealth);
                                myTarget.health =
                                    EditorGUI.IntField(new Rect(400 * rect.x, 130 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Health : ", myTarget.health);
                                moveTarget.speed =
                                    EditorGUI.IntField(new Rect(400 * rect.x, 160 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Speed : ", moveTarget.speed);
                                moveTarget.rotateSpeed =
                                    EditorGUI.IntField(new Rect(400 * rect.x, 190 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Rotate Speed : ", moveTarget.rotateSpeed);
                                if (target.UnitTypes.Length > 0)
                                {
                                    string[] typeNames = new string[target.UnitTypes.Length];
                                    for (int x = 0; x < target.UnitTypes.Length; x++)
                                    ...
                                    arraySelect =
                                        EditorGUI.Popup(new Rect(400 * rect.x, 220 * rect.y, 545 * rect.x, 25 * rect.y),
                                            "Type : ", arraySelect, typeNames);
                                    myTarget.type = target.UnitTypes[arraySelect];
                                }
                                nTarget.UnitList[unitId].obj = EditorGUI.ObjectField(
                                    new Rect(400 * rect.x, 250 * rect.y, 540 * rect.x, 25 * rect.y), "Object : ",
                                    nTarget.UnitList[unitId].obj, typeof(GameObject),
                                    true) as GameObject;
                            ...
                            {
                                helpState = 6;
                                GUI.DrawTexture(new Rect(620 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                myTarget.weapon.fighterUnit =
                                    EditorGUI.Toggle(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Fighter : ", myTarget.weapon.fighterUnit);
                                if (myTarget.weapon.fighterUnit)
                                {
                                    ...
                                    myTarget.weapon.attackObj = EditorGUI.ObjectField(
                                        ...
                                        "Attack Object : ",
                                        myTarget.weapon.attackObj, typeof(GameObject),
                                        true) as GameObject;
                                }
                            }
                            // Build
                            ...
                            {
                                helpState = 7;
                                GUI.DrawTexture(new Rect(840 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                myTarget.build.builderUnit =
                                    EditorGUI.Toggle(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Builder : ", myTarget.build.builderUnit);
                            ...
                            {
                                helpState = 8;
                                GUI.DrawTexture(new Rect(1060 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                myTarget.resource.resourceUnit = EditorGUI.Toggle(
                                    new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y), "Gatherer : ",
                                ...
                                if (myTarget.resource.resourceUnit)
                                {
                                    ...
                                    if (resourceManager != null)
                                    {
                                        ...
                                        if (rMScript)
                                        {
                                            ...
                                            {
                                                ModifyUR(rMScript.resourceTypes.Length,
                                                    myTarget.resource.behaviour.Length, myTarget);
                                            }
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    arraySelect =
                                                        EditorGUI.Popup(
                                                            new Rect(400 * rect.x, 100 * rect.y, 540 * rect.x,
                                                                25 * rect.y), arraySelect, resourceNames);
                                                    if (myTarget.resource.behaviour[arraySelect].canGather)
                                                    {
                                                        GUI.Box(
                                                            new Rect(400 * rect.x, 130 * rect.y, 540 * rect.x,
                                                                150 * rect.y), "");
                                                    }
                                                    else
                                                    {
                                                    ...
                                                    myTarget.resource.behaviour[arraySelect].canGather =
                                                        EditorGUI.Toggle(
                                                            new Rect(400 * rect.x, 130 * rect.y, 540 * rect.x,
                                                                25 * rect.y),
                                                            "Can Gather : ",
                                                    ...
                                                    if (myTarget.resource.behaviour[arraySelect].canGather)
                                                    {
                                                        myTarget.resource.behaviour[arraySelect].amount =
                                                            EditorGUI.IntField(
                                                                new Rect(400 * rect.x, 160 * rect.y, 540 * rect.x,
                                                                    25 * rect.y),
                                                                "Gather Amount : ",
                                                                myTarget.resource.behaviour[arraySelect].amount);
                                                        myTarget.resource.behaviour[arraySelect].rate =
                                                            EditorGUI.FloatField(
                                                                new Rect(400 * rect.x, 190 * rect.y, 540 * rect.x,
                                                                    25 * rect.y),
                                                                "Gather Rate : ",
                                                                myTarget.resource.behaviour[arraySelect].rate);
                                                        myTarget.resource.behaviour[arraySelect].returnWhenFull =
                                                            EditorGUI.Toggle(
                                                                new Rect(400 * rect.x, 220 * rect.y, 540 * rect.x,
                                                                    25 * rect.y), "Drop Off Resource : ",
                                                                myTarget.resource.behaviour[arraySelect]
                                                                    .returnWhenFull);
                                                    }
                                                    myTarget.resource.behaviour[arraySelect].carryCapacity =
                                                        EditorGUI.IntField(
                                                            new Rect(400 * rect.x, 250 * rect.y, 540 * rect.x,
                                                                25 * rect.y), "Carry Capacity : ",
                                                            myTarget.resource.behaviour[arraySelect].carryCapacity);
                                                }
                                            }
                                        }
                            ...
                            {
                                GUI.DrawTexture(new Rect(1280 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                ...
                                if (GUI.Button(new Rect(673 * rect.x, 50 * rect.y, 272 * rect.x, 20 * rect.y),
                                    "Remove"))
                                {
                                    ModifyURA(myTarget.ratio.Length - 1, myTarget.ratio.Length, myTarget);
                                }
                        ...
                        {
                            GUI.DrawTexture(new Rect(675 * rect.x, 0, 275 * rect.x, 25 * rect.y), selectionTexture,
                                ScaleMode.StretchToFill);
                            if (GUI.Button(new Rect(400 * rect.x, 25 * rect.y, 367 * rect.x, 20 * rect.y),
                                "Selected"))
                            {
                                subMenuState = 0;
                                arraySelect = 0;
                            ...
                            if (subMenuState == 0)
                            {
                                GUI.DrawTexture(new Rect(400 * rect.x, 25 * rect.y, 367 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                myTarget.gui.SetType("Unit");
                                EditorGUI.LabelField(new Rect(400 * rect.x, 50 * rect.y, 545 * rect.x, 100 * rect.y),
                                    "GUI Image : ");
                                myTarget.gui.image =
                                    EditorGUI.ObjectField(
                                        new Rect(400 * rect.x, 80 * rect.y, 100 * rect.x, 100 * rect.y), "",
                                        myTarget.gui.image, typeof(Texture2D), true) as Texture2D;
                                //Modify Selected Objects
                                if (GUI.Button(new Rect(400 * rect.x, 180 * rect.y, 273 * rect.x, 25 * rect.y),
                                    "Add"))
                                {
                                    ModifyUS(myTarget.gui.selectObjs.Length + 1, myTarget.gui.selectObjs.Length,
                                        myTarget);
                                }
                                if (GUI.Button(new Rect(673 * rect.x, 180 * rect.y, 272 * rect.x, 25 * rect.y),
                                    "Remove"))
                                {
                                    ModifyUS(myTarget.gui.selectObjs.Length - 1, myTarget.gui.selectObjs.Length,
                                        myTarget);
                                ...
                                arraySelect =
                                    EditorGUI.Popup(new Rect(400 * rect.x, 210 * rect.y, 545 * rect.x, 25 * rect.y),
                                        "Objects : ", arraySelect, list);
                                ...
                                if (healthObj == null)
                                {
                                    if (GUI.Button(new Rect(400 * rect.x, 280 * rect.y, 545 * rect.x, 420 * rect.y),
                                ...
                                else
                                {
                                    ...
                                    if (healthLength > 0)
                                    {
                                        ...
                                        arraySelect1 =
                                            EditorGUI.Popup(
                                                ...
                                                "Element : ", arraySelect1, elementName);
                                    ...
                                    {
                                        GUI.DrawTexture(
                                            new Rect(point.x, point.y, healthObj.scale * ((float) 50 / 100),
                                                healthObj.yScale), healthObj.healthBar);
                                    }
                                    for (int x = 0; x < healthObj.element.Length; x++)
                                    {
                                        GUI.DrawTexture(
                                            new Rect(point.x + healthObj.element[x].loc.x,
                                                (point.y - healthObj.element[x].loc.y), healthObj.element[x].loc.width,
                            ...
                            {
                                GUI.DrawTexture(new Rect(767 * rect.x, 25 * rect.y, 367 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                if (myTargetMap == null)
                                {
                                    if (GUI.Button(new Rect(400 * rect.x, 45 * rect.y, 1100 * rect.x, 705 * rect.y),
                                ...
                                else
                                {
                                    myTargetMap.enabled =
                                        EditorGUI.Toggle(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                            "MiniMap Signal : ", myTargetMap.enabled);
                                    if (myTargetMap.enabled)
                                    {
                                        myTargetMap.miniMapTag =
                                            EditorGUI.TextField(
                                                new Rect(400 * rect.x, 100 * rect.y, 540 * rect.x, 25 * rect.y),
                                                "Tag : ", "" + myTargetMap.miniMapTag);
                                                ...
                                                for (int x = 0; x < map.elements.Length; x++)
                                                {
                                                    if (map.elements[x].tag == myTargetMap.miniMapTag)
                                                    {
                                                        ...
                                                        GUI.DrawTexture(
                                                            ...
                                                            map.elements[x].image);
                                                        GUI.color = defaultColor;
                                                        map.elements[x].image =
                                                            EditorGUI.ObjectField(
                                                                new Rect(400 * rect.x, 185 * rect.y, 100, 100),
                                                                map.elements[x].image, typeof(Texture2D),
                                                                true) as Texture2D;
                                                        miniMapState =
                                                            EditorGUI.IntField(
                                                                new Rect(400 * rect.x, 320 * rect.y, 540 * rect.x,
                                                                    25 * rect.y), "Group : ", miniMapState);
                                                    }
                                                }
                                            }
                                            else
                            ...
                            {
                                GUI.DrawTexture(new Rect(1134 * rect.x, 25 * rect.y, 366 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                ...
                                else
                                {
                                    myTargetVision.enabled =
                                        EditorGUI.Toggle(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                            "Vision Signal : ", myTargetVision.enabled);
                                    if (myTargetVision.enabled)
                                    {
                                        myTargetVision.radius =
                                            EditorGUI.IntField(
                                                new Rect(400 * rect.x, 100 * rect.y, 540 * rect.x, 25 * rect.y),
                                                "Radius : ", myTargetVision.radius);
                        ...
                        {
                            GUI.DrawTexture(new Rect(950 * rect.x, 0, 275 * rect.x, 25 * rect.y), selectionTexture,
                                ScaleMode.StretchToFill);
                            ...
                            if (nTarget.Tech.Length > 0 && myTarget.techEffect.Length > 0)
                            {
                                ...
                                arraySelect =
                                    EditorGUI.Popup(new Rect(400 * rect.x, 75 * rect.y, 545 * rect.x, 20 * rect.y),
                                        "Techs : ", arraySelect, unitTechs);
                                ...
                                else
                                {
                                    ...
                                    arraySelect2 =
                                        EditorGUI.Popup(
                                            ...
                                            "Tech Options : ", arraySelect2, nameArray);
                                    curY += 25;
                                    ...
                                    myTarget.techEffect[arraySelect].replacementObject = EditorGUI.ObjectField(
                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 20 * rect.y),
                                        "Replacement Object : ",
                                        myTarget.techEffect[arraySelect].replacementObject, typeof(GameObject),
                                    ...
                                    string[,] functions = new string[24, 4]
                                    {
                                        ...
                                        /* 6 */
                                        {"GetAttackRange", "SetAttackRange", "AddAttackRange", "SubAttackRange"},
                                        /* 7 */
                                        {"GetAttackDamage", "SetAttackDamage", "AddAttackDamage", "SubAttackDamage"},
                                        ...
                                        /* 13 */
                                        {
                                            "GetResourceAmount", "SetResourceAmount", "AddResourceAmount",
                                            "SubResourceAmount"
                                        },
                                        /* 14 */
                                        {"GetResourceRate", "SetResourceRate", "AddResourceRate", "SubResourceRate"},
                                        /* 15 */
                                        {"GetBuilderUnit", "SetBuilderUnit", "AddBuilderUnit", "SubBuilderUnit"},
                                        /* 16 */ {"GetCanBuild", "SetCanBuild", "", ""},
                                        /* 17 */
                                        {
                                            "GetBuilderAmount", "SetBuilderAmount", "AddBuilderAmount",
                                            "SubBuilderAmount"
                                        },
                                        /* 18 */
                                        {"GetBuilderRate", "SetBuilderRate", "AddBuilderRate", "SubBuilderRate"},
                                        /* 19 */ {"GetSpeed", "SetSpeed", "AddSpeed", "SubSpeed"},
                                        /* 20 */
                                        {"GetRotateSpeed", "SetRotateSpeed", "AddRotateSpeed", "SubRotateSpeed"},
                                        /* 21 */ {"GetMiniMapTag", "SetMiniMapTag", "AddMiniMapTag", "SubMiniMapTag"},
                                        /* 22 */
                                        {"GetVisionRadius", "SetVisionRadius", "AddVisionRadius", "SubVisionRadius"},
                                        /* 23 */
                                        {"GetCarryCapacity", "SetCarryCapacity", "AddCarryCapacity", "SubCarryCapacity"}
                                    };
                                    string[] variableName =
                                    {
                                    ...
                                    for (int x = 0; x < myTarget.techEffect[arraySelect].effects.Length; x++)
                                    {
                                        myTarget.techEffect[arraySelect].effects[x].effectName = EditorGUI.Popup(
                                            ...
                                            myTarget.techEffect[arraySelect].effects[x].effectName, variableName);
                                        int index = myTarget.techEffect[arraySelect].effects[x].effectName;
                                        string[] funcTypes;
                                        if (index == 0 || index == 3 || index == 4 || index == 11 || index == 12 ||
                                            index == 15 || index == 16 || index == 21)
                                        {
                                        ...
                                        myTarget.techEffect[arraySelect].effects[x].funcType = EditorGUI.Popup(
                                            ...
                                            myTarget.techEffect[arraySelect].effects[x].funcType, funcTypes);
                                        myTarget.techEffect[arraySelect].effects[x].funcName = functions[index,
                                            ...
                                            else if (index == 12 || index == 16)
                                            {
                                                if (index == 12)
                                                {
                                                    ...
                                                    if (resourceManager != null)
                                                    {
                                                        ...
                                                        if (rMScript)
                                                        {
                                                            if (myTarget.resource.behaviour.Length != rMScript
                                                            ...
                                                            {
                                                                string[] resourceNames = new string[rMScript
                                                                    .resourceTypes.Length];
                                                                ...
                                                                {
                                                                    if (myTarget.techEffect[arraySelect]
                                                                            .effects[x]
                                                                            .index >= resourceNames.Length)
                                                                    {
                                                                        myTarget.techEffect[arraySelect]
                                                                            .effects[x]
                                                                            .index = 0;
                                                                    }
                                                                    myTarget.techEffect[arraySelect].effects[x].index =
                                                                        EditorGUI.Popup(
                                                                            new Rect(700 * rect.x, curY * rect.y,
                                                                                100 * rect.x, 20 * rect.y), "",
                                                                            myTarget.techEffect[arraySelect]
                                                                                .effects[x]
                                                                                .index, resourceNames);
                                                                    myTarget.techEffect[arraySelect].effects[x].toggle =
                                                                        EditorGUI.Toggle(
                                                                            new Rect(800 * rect.x, curY * rect.y,
                                                                                145 * rect.x, 20 * rect.y), "",
                                                                            myTarget.techEffect[arraySelect]
                                                                                .effects[x]
                                                                                .toggle);
                                                                }
                                                ...
                                                else if (index == 16)
                                                {
                                                    ...
                                                    if (myTarget.build.build.Length != nTarget.BuildingList.Length)
                                                    {
                                                        ModifyUB(nTarget.BuildingList.Length,
                                                            myTarget.build.build.Length, myTarget);
                                                    }
                                                    else
                                                    {
                                                        string[] buildNames = new string[nTarget.BuildingList.Length];
                                                        ...
                                                        {
                                                            if (myTarget.techEffect[arraySelect].effects[x].index >=
                                                                buildNames.Length)
                                                            {
                                                            ...
                                                            myTarget.techEffect[arraySelect].effects[x].index =
                                                                EditorGUI.Popup(
                                                                    new Rect(700 * rect.x, curY * rect.y, 100 * rect.x,
                                                                        20 * rect.y), "",
                                                                    myTarget.techEffect[arraySelect].effects[x].index,
                                                                    buildNames);
                                                            myTarget.techEffect[arraySelect].effects[x].toggle =
                                                                EditorGUI.Toggle(
                                                                    new Rect(800 * rect.x, curY * rect.y, 145 * rect.x,
                                                                        20 * rect.y), "",
                                                                    myTarget.techEffect[arraySelect].effects[x].toggle);
                                                        }
                                                    }
                                    ...
                                    if (GUI.Button(new Rect(400 * rect.x, curY * rect.y, 273 * rect.x, 20 * rect.y),
                                        "Add"))
                                    {
                                        ModifyUTE(myTarget.techEffect[arraySelect].effects.Length + 1,
                                            myTarget.techEffect[arraySelect].effects.Length, myTarget, arraySelect);
                                    }
                                    if (GUI.Button(new Rect(673 * rect.x, curY * rect.y, 272 * rect.x, 20 * rect.y),
                                        "Remove"))
                                    {
                                        ModifyUTE(myTarget.techEffect[arraySelect].effects.Length - 1,
                                            myTarget.techEffect[arraySelect].effects.Length, myTarget, arraySelect);
                        ...
                        {
                            GUI.DrawTexture(new Rect(1225 * rect.x, 0, 275 * rect.x, 25 * rect.y), selectionTexture,
                                ScaleMode.StretchToFill);
                            GUI.Box(new Rect(400 * rect.x, 25 * rect.y, 1100 * rect.x, 20 * rect.y), "");
                            ...
                            if (myTarget.anim.manager)
                            {
                                myTarget.anim.manager.runtimeAnimatorController = EditorGUI.ObjectField(
                                    new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y), "Controller : ",
                                    myTarget.anim.manager.runtimeAnimatorController, typeof(RuntimeAnimatorController),
                                    allowSceneObjects: false) as RuntimeAnimatorController;
                            }
                            else if (comp)
                            {
                            ...
                            {
                                if (GUI.Button(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                    "Add Animator"))
                                {
                            ...
                            myTarget.anim.idleAudio = EditorGUI.ObjectField(
                                ...
                                typeof(AudioClip),
                                allowSceneObjects: false) as AudioClip;
                            myTarget.anim.moveAudio = EditorGUI.ObjectField(
                                new Rect(400 * rect.x, 130 * rect.y, 540 * rect.x, 25 * rect.y), "Move Audio : ",
                                myTarget.anim.moveAudio,
                                typeof(AudioClip),
                                allowSceneObjects: false) as AudioClip;
                            myTarget.anim.gatherAudio = EditorGUI.ObjectField(
                                new Rect(400 * rect.x, 160 * rect.y, 540 * rect.x, 25 * rect.y), "Gather Audio : ",
                                myTarget.anim.gatherAudio,
                                typeof(AudioClip),
                                allowSceneObjects: false) as AudioClip;
                            myTarget.anim.buildAudio = EditorGUI.ObjectField(
                                new Rect(400 * rect.x, 190 * rect.y, 540 * rect.x, 25 * rect.y), "Build Audio : ",
                                myTarget.anim.buildAudio,
                                typeof(AudioClip),
                                allowSceneObjects: false) as AudioClip;
                            myTarget.anim.attackAudio = EditorGUI.ObjectField(
                                new Rect(400 * rect.x, 220 * rect.y, 540 * rect.x, 25 * rect.y), "Attack Audio : ",
                                myTarget.anim.attackAudio,
                                typeof(AudioClip),
                                allowSceneObjects: false) as AudioClip;
                            myTarget.anim.deathObject = EditorGUI.ObjectField(
                                new Rect(400 * rect.x, 250 * rect.y, 540 * rect.x, 25 * rect.y), "Death Object : ",
                ...
                if (nTarget.BuildingList[unitId].obj)
                {
                    ...
                    if (myTarget)
                    {
                        ...
                        if (menuState == 0)
                        {
                            ...
                            if (GUI.Button(new Rect(620 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                "Production"))
                            {
                                subMenuState = 2;
                                arraySelect = 0;
                            ...
                            if (GUI.Button(new Rect(1060 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                "Generate"))
                            {
                                subMenuState = 4;
                                arraySelect = 0;
                            }
                            if (GUI.Button(new Rect(1280 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                "Drop Off"))
                            {
                                subMenuState = 5;
                                arraySelect = 0;
                            ...
                            if (subMenuState == 0)
                            {
                                ...
                                nTarget.BuildingList[unitId].autoBuild = EditorGUI.Toggle(
                                    new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y), "Auto Build : ",
                                    nTarget.BuildingList[unitId].autoBuild);
                                nTarget.BuildingList[unitId].tempObj = EditorGUI.ObjectField(
                                    new Rect(400 * rect.x, 100 * rect.y, 540 * rect.x, 25 * rect.y), "Temporary : ",
                                ...
                                if (!nTarget.BuildingList[unitId].autoBuild)
                                {
                                    nTarget.BuildingList[unitId].progressObj = EditorGUI.ObjectField(
                                        new Rect(400 * rect.x, curY * rect.y, 540 * rect.x, 25 * rect.y), "Progress : ",
                                        nTarget.BuildingList[unitId].progressObj, typeof(GameObject),
                                        true) as GameObject;
                                    curY += 30;
                                }
                                nTarget.BuildingList[unitId].obj = EditorGUI.ObjectField(
                                    new Rect(400 * rect.x, curY * rect.y, 540 * rect.x, 25 * rect.y), "Final : ",
                                    nTarget.BuildingList[unitId].obj,
                                    typeof(GameObject), true) as GameObject;
                                curY += 30;
                                myTarget.name =
                                    EditorGUI.TextField(
                                        new Rect(400 * rect.x, curY * rect.y, 540 * rect.x, 25 * rect.y), "Name : ",
                                        myTarget.name);
                                curY += 30;
                                myTarget.maxHealth =
                                    EditorGUI.IntField(new Rect(400 * rect.x, curY * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Max Health : ", myTarget.maxHealth);
                                curY += 30;
                                myTarget.health =
                                    EditorGUI.IntField(new Rect(400 * rect.x, curY * rect.y, 540 * rect.x, 25 * rect.y),
                                ...
                                if (target.UnitTypes.Length > 0)
                                {
                                    ...
                                    arraySelect =
                                        EditorGUI.Popup(
                                            new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y), "Type : ",
                                            arraySelect, typeNames);
                                    myTarget.type = target.UnitTypes[arraySelect];
                                    curY += 30;
                                }
                                if (nTarget.BuildingList[unitId].progressObj)
                                {
                                    ...
                                    {
                                        progressObj = nTarget.BuildingList[unitId]
                                            .progressObj.AddComponent<BuildingController>();
                                        progressObj.buildingType = BuildingType.ProgressBuilding;
                                    }
                                }
                                ...
                                arraySelect3 =
                                    EditorGUI.Popup(new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y),
                                        "Resource Type : ", arraySelect3, costs);
                                curY += 25;
                                ...
                                else
                                {
                                    nTarget.BuildingList[unitId].cost[arraySelect3] = EditorGUI.IntField(
                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y), "Cost : ",
                            ...
                            else if (subMenuState == 2)
                            {
                                ...
                                arraySelect =
                                    EditorGUI.Popup(new Rect(400 * rect.x, 70 * rect.y, 540 * rect.x, 25 * rect.y),
                                        "Production Type : ", arraySelect, options);
                                if (arraySelect == 0)
                                {
                                    ...
                                    if (myTarget.unitProduction.canProduce)
                                    {
                                        ...
                                        if (myTarget.unitProduction.units.Length > 0)
                                        {
                                            ...
                                            for (int x = 0; x < myTarget.unitProduction.units.Length; x++)
                                            {
                                                ...
                                                {
                                                    produceNames[x] =
                                                        (x + 1) + ". " + myTarget.unitProduction.units[x].customName;
                                                }
                                            }
                                            if (GUI.Button(
                                                ...
                                                "Add Unit"))
                                            {
                                                ModifyGBU(myTarget.unitProduction.units.Length + 1,
                                                    myTarget.unitProduction.units.Length, arraySelect);
                                            }
                                            if (GUI.Button(
                                            ...
                                            arraySelect2 =
                                                EditorGUI.Popup(
                                                    ...
                                                    "Production : ", arraySelect2, produceNames);
                                            curY += 20;
                                            if (arraySelect2 >= myTarget.unitProduction.units.Length ||
                                                arraySelect2 < 0)
                                            {
                                            ...
                                            else
                                            {
                                                myTarget.unitProduction.units[arraySelect2].customName =
                                                    EditorGUI.TextField(
                                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                            25 * rect.y),
                                                        "Custom Name : ",
                                                        myTarget.unitProduction.units[arraySelect2].customName);
                                                curY += 30;
                                                ...
                                                myTarget.unitProduction.units[arraySelect2].customTexture =
                                                    EditorGUI.ObjectField(
                                                        new Rect(600 * rect.x, curY * rect.y, 150 * rect.x,
                                                            100 * rect.y),
                                                        myTarget.unitProduction.units[arraySelect2].customTexture,
                                                        typeof(Texture2D), true) as Texture2D;
                                                curY += 110;
                                                ...
                                                curY += 30;
                                                ResourceManager mg =
                                                    GameObject.Find("Player Manager").GetComponent<ResourceManager>();
                                                if (myTarget.unitProduction.units[arraySelect2].cost.Length !=
                                                    mg.resourceTypes.Length)
                                                {
                                                    myTarget.unitProduction.units[arraySelect2].cost =
                                                        new int[mg.resourceTypes.Length];
                                                }
                                                string[] costs = new string[mg.resourceTypes.Length];
                                                for (int x = 0; x < costs.Length; x++)
                                                {
                                                ...
                                                arraySelect3 =
                                                    EditorGUI.Popup(
                                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                            25 * rect.y), "Resource Type : ", arraySelect3, costs);
                                                curY += 25;
                                                if (arraySelect3 >= costs.Length)
                                                {
                                                    arraySelect3 = 0;
                                                    ...
                                                    myTarget.unitProduction.units[arraySelect2].cost[arraySelect3] =
                                                        EditorGUI.IntField(
                                                            new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                                25 * rect.y),
                                                            "Cost to Produce : ",
                                                            myTarget.unitProduction.units[arraySelect2]
                                                                .cost[arraySelect3]);
                                                    curY += 30;
                                                }
                                                GUI.skin.textArea.wordWrap = true;
                                    ...
                                    if (myTarget.techProduction.canProduce)
                                    {
                                        ...
                                        if (myTarget.techProduction.techs.Length > 0)
                                        {
                                            ...
                                            if (GUI.Button(
                                                ...
                                                "Add Tech"))
                                            {
                                                ModifyGBT(myTarget.techProduction.techs.Length + 1,
                                                    myTarget.techProduction.techs.Length, arraySelect);
                                            }
                                            if (GUI.Button(
                                                new Rect(670 * rect.x, curY * rect.y, 270 * rect.x, 15 * rect.y),
                                                "Remove Tech"))
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    myTarget.techProduction.techs[arraySelect2] =
                                                        new ProduceTech();
                                                }
                                                ...
                                                EditorGUI.LabelField(
                                                    new Rect(400 * rect.x, curY * rect.y, 150 * rect.x, 100 * rect.y),
                                                    "Custom Texture : ");
                                                myTarget.techProduction.techs[arraySelect2].customTexture =
                                                    EditorGUI.ObjectField(
                                                        new Rect(600 * rect.x, curY * rect.y, 150 * rect.x,
                                                            100 * rect.y),
                                                        myTarget.techProduction.techs[arraySelect2].customTexture,
                                                ...
                                                myTarget.techProduction.techs[arraySelect2].index = EditorGUI.Popup(
                                                    new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y),
                                                    "Tech To Produce : ",
                                                    myTarget.techProduction.techs[arraySelect2].index, nameArray);
                                                if (myTarget.techProduction.techs[arraySelect2].index >= size ||
                                                ...
                                                {
                                                    myTarget.techProduction.techs[arraySelect2].techName =
                                                        names[myTarget.techProduction.techs[arraySelect2].index];
                                                }
                                                curY += 20;
                                                myTarget.techProduction.techs[arraySelect2].canProduce =
                                                    EditorGUI.Toggle(
                                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                            25 * rect.y),
                                                        "Can Produce : ",
                                                        myTarget.techProduction.techs[arraySelect2].canProduce);
                                                curY += 20;
                                                myTarget.techProduction.techs[arraySelect2].dur = EditorGUI.FloatField(
                                                    new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y),
                                                    "Duration : ",
                                                    myTarget.techProduction.techs[arraySelect2].dur);
                                                curY += 25;
                                                myTarget.techProduction.techs[arraySelect2].rate = EditorGUI.FloatField(
                                                    new Rect(400 * rect.x, curY * rect.y, 545 * rect.x, 25 * rect.y),
                                                    "Rate : ",
                                                    myTarget.techProduction.techs[arraySelect2].rate);
                                                curY += 30;
                                                myTarget.techProduction.techs[arraySelect2].amount =
                                                    EditorGUI.FloatField(
                                                        new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                            25 * rect.y),
                                                        "Amount : ",
                                                ...
                                                ResourceManager mg =
                                                    GameObject.Find("Player Manager").GetComponent<ResourceManager>();
                                                if (myTarget.techProduction.techs[arraySelect2].cost.Length !=
                                                    mg.resourceTypes.Length)
                                                {
                                                    myTarget.techProduction.techs[arraySelect2].cost =
                                                        new int[mg.resourceTypes.Length];
                                                }
                                                string[] costs = new string[mg.resourceTypes.Length];
                                                for (int x = 0; x < costs.Length; x++)
                                                ...
                                                {
                                                    myTarget.techProduction.techs[arraySelect2].cost[arraySelect3] =
                                                        EditorGUI.IntField(
                                                            new Rect(400 * rect.x, curY * rect.y, 545 * rect.x,
                                                                25 * rect.y),
                                                            "Cost to Produce : ",
                            ...
                            else if (subMenuState == 3)
                            {
                                ...
                                nTarget.BuildingList[unitId].closeWidth = EditorGUI.IntField(
                                    new Rect(400 * rect.x, 70 * rect.y, 1100 * rect.x, 25 * rect.y), "Close Width : ",
                                    nTarget.BuildingList[unitId].closeWidth);
                                nTarget.BuildingList[unitId].closeLength = EditorGUI.IntField(
                                    new Rect(400 * rect.x, 100 * rect.y, 1100 * rect.x, 25 * rect.y), "Close Length : ",
                                ...
                                groupPosition2 = GUI.BeginScrollView(
                                    new Rect(400 * rect.x, 130 * rect.y, 1100 * rect.x, 570 * rect.y), groupPosition2,
                                    new Rect(0, 0, 30 * (nTarget.BuildingList[unitId].closeWidth * 2 + 1) + 60,
                                ...
                                for (int x = 0; x < nTarget.BuildingList[unitId].closeWidth * 2 + 1; x++)
                                {
                                    GUI.Label(
                                        new Rect(30 + 30 * x,
                                            30 + 30 * (nTarget.BuildingList[unitId].closeLength * 2 + 1), 30, 30),
                                        "" + x);
                                }
                                for (int y = 0; y < nTarget.BuildingList[unitId].closeLength * 2 + 1; y++)
                                {
                                    GUI.Label(
                                        new Rect(30 + 30 * (nTarget.BuildingList[unitId].closeWidth * 2 + 1),
                                            30 + 30 * y, 30, 30), "" + y);
                                }
                                GUI.EndScrollView();
                            }
                            ...
                            else if (subMenuState == 4)
                            {
                                ...
                                ResourceGenerate gen = nTarget.BuildingList[unitId]
                                    .obj.GetComponent<ResourceGenerate>();
                                if (gen != null)
                                {
                                    ResourceManager rm = GameObject.Find("Player Manager")
                                        ...
                                        else
                                        {
                                            ...
                                            arraySelect =
                                                EditorGUI.Popup(
                                                    ...
                                                    "Resource Type : ", arraySelect, types);
                                ...
                                {
                                    if (GUI.Button(new Rect(400 * rect.x, 50 * rect.y, 540 * rect.x, 650 * rect.y),
                            ...
                            else if (subMenuState == 5)
                            {
                                GUI.DrawTexture(new Rect(1280 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                ResourceDropOff dropOff = nTarget.BuildingList[unitId]
                                    .obj.GetComponent<ResourceDropOff>();
                                if (dropOff != null)
                                {
                                    ResourceManager rm = GameObject.Find("Player Manager")
                                        .GetComponent<ResourceManager>();
                        ...
                        else if (menuState == 1)
                        {
                            ...
                            GUI.DrawTexture(new Rect(675 * rect.x, 0, 275 * rect.x, 25 * rect.y), selectionTexture,
                                ScaleMode.StretchToFill);
                            if (GUI.Button(new Rect(400 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                "Selected"))
                            {
                                subMenuState = 0;
                                arraySelect = 0;
                            ...
                            if (subMenuState == 0)
                            {
                                ...
                                if (GUI.Button(new Rect(400 * rect.x, 180 * rect.y, 273 * rect.x, 25 * rect.y),
                                    "Add"))
                                {
                                    ModifyBS(myTarget.gui.selectObjs.Length + 1, myTarget.gui.selectObjs.Length,
                                        myTarget);
                                }
                                if (GUI.Button(new Rect(673 * rect.x, 180 * rect.y, 272 * rect.x, 25 * rect.y),
                                    "Remove"))
                            ...
                            else if (subMenuState == 1)
                            {
                                ...
                                arraySelect =
                                    EditorGUI.Popup(new Rect(400 * rect.x, 50 * rect.y, 550 * rect.x, 20 * rect.y),
                                        "Type : ", arraySelect, name);
                                if (arraySelect == 0)
                                {
                                    myTarget.bGUI.unitGUI.startPos = EditorGUI.Vector2Field(
                                        new Rect(400 * rect.x, 75 * rect.y, 545 * rect.x, 25 * rect.y), "Start Pos : ",
                            ...
                            else if (subMenuState == 4)
                            {
                                GUI.DrawTexture(new Rect(1280 * rect.x, 25 * rect.y, 220 * rect.x, 20 * rect.y),
                                    selectionTexture, ScaleMode.StretchToFill);
                                Progress progressObj = nTarget.BuildingList[unitId]
                                    .progressObj.GetComponent<Progress>();
                                if (progressObj == null)
                                {
                                    if (GUI.Button(new Rect(400 * rect.x, 50 * rect.y, 545 * rect.x, 750 * rect.y),
                                ...
                                else
                                {
                                    ...
                                    progressObj.scale =
                                        EditorGUI.IntField(
                                            ...
                                            "UI-X Scale : ", progressObj.scale);
                                    progressObj.yScale =
                                        EditorGUI.IntField(
                                            new Rect(400 * rect.x, 130 * rect.y, 545 * rect.x, 30 * rect.y),
                                            "UI-Y Scale : ", progressObj.yScale);
                                    progressObj.color =
                                        EditorGUI.ColorField(
                                            new Rect(400 * rect.x, 160 * rect.y, 545 * rect.x, 30 * rect.y), "Color : ",
                                            progressObj.color);
                                    int nl = progressObj.texture.Length;
                                    nl = EditorGUI.IntField(
                                        new Rect(400 * rect.x, 190 * rect.y, 545 * rect.x, 30 * rect.y), "Textures : ",
                                        nl);
                        ...
                        else if (menuState == 2)
                        {
                            ...
                            if (nTarget.Tech.Length > 0 && myTarget.techEffect.Length > 0)
                            {
                                ...
                                arraySelect =
                                    EditorGUI.Popup(new Rect(400 * rect.x, 75 * rect.y, 1100 * rect.x, 20 * rect.y),
                                        "Techs : ", arraySelect, unitTechs);
                                if (arraySelect >= myTarget.techEffect.Length)
                                {
                                    arraySelect = 0;
                                ...
                                arraySelect2 = myTarget.techEffect[arraySelect].index;
                                arraySelect2 =
                                    EditorGUI.Popup(new Rect(400 * rect.x, curY * rect.y, 1100 * rect.x, 20 * rect.y),
                                        "Tech Options : ", arraySelect2, nameArray);
                                curY += 25;
                                myTarget.techEffect[arraySelect].index = arraySelect2;
                                if (arraySelect2 > nameArray.Length)
                                ...
                                string[,] functions = new string[18, 4]
                                {
                                    ...
                                    /* 9 */
                                    {
                                        "GetUCanBuildAtOnce", "SetUCanBuildAtOnce", "AddUCanBuildAtOnce",
                                        "SubUCanBuildAtOnce"
                                    },
                                    ...
                                    /* 17 */
                                    {
                                        "GetTCanBuildAtOnce", "SetTCanBuildAtOnce", "AddTCanBuildAtOnce",
                                        "SubTCanBuildAtOnce"
                                    },
                                };
                                string[] variableName =
                                ...
                                for (int x = 0; x < myTarget.techEffect[arraySelect].effects.Length; x++)
                                {
                                    ...
                                    //{
                                    string[] funcTypes;
                                    if (index == 0 || index == 3 || index == 4 || index == 5 || index == 11 ||
                                        index == 13)
                                    {
                                        funcTypes = new string[2];
                                        funcTypes[0] = "Get";
                                    ...
                                    else
                                    {
                                        ...
                                        for (int y = 0; y < myTarget.unitProduction.units.Length; y++)
                                        {
                                            ...
                                            {
                                                produceNames[y] =
                                                    (y + 1) + ". " + myTarget.unitProduction.units[y].customName;
                                            }
                                        }
                                        ...
                                        for (int y = 0; y < myTarget.techProduction.techs.Length; y++)
                                        {
                                            ...
                                            {
                                                produceTNames[y] =
                                                    (y + 1) + ". " + myTarget.techProduction.techs[y].customName;
                                            }
                                        }
                                        if (index == 0)
                                        {
                                        ...
                                        else if (index == 5)
                                        {
                                            myTarget.techEffect[arraySelect].effects[x].index = EditorGUI.Popup(
                                                ...
                                                myTarget.techEffect[arraySelect].effects[x].index, produceNames);
                                            myTarget.techEffect[arraySelect].effects[x].toggle = EditorGUI.Toggle(
                                                new Rect(1000 * rect.x, curY * rect.y, 290 * rect.x, 20 * rect.y), "",
                                                myTarget.techEffect[arraySelect].effects[x].toggle);
                                        }
                                        else if (index == 13)
                                        {
                                            myTarget.techEffect[arraySelect].effects[x].index = EditorGUI.Popup(
                                                new Rect(1290 * rect.x, curY * rect.y, 210 * rect.x, 20 * rect.y), "",
                                                myTarget.techEffect[arraySelect].effects[x].index, produceTNames);
                                            myTarget.techEffect[arraySelect].effects[x].toggle = EditorGUI.Toggle(
                                                new Rect(1000 * rect.x, curY * rect.y, 290 * rect.x, 20 * rect.y), "",
                                                myTarget.techEffect[arraySelect].effects[x].toggle);
                                        }
                                                ...
                                                if (rMScript)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (index == 6)
                                                        {
                                                            myTarget.techEffect[arraySelect].effects[x].index =
                                                                EditorGUI.Popup(
                                                                    new Rect(1290 * rect.x, curY * rect.y, 100 * rect.x,
                                                                        20 * rect.y), "",
                                                                    myTarget.techEffect[arraySelect].effects[x].index,
                                                                    produceNames);
                                                            myTarget.techEffect[arraySelect].effects[x].index1 =
                                                                EditorGUI.Popup(
                                                                    new Rect(1390 * rect.x, curY * rect.y, 110 * rect.x,
                                                                        20 * rect.y), "",
                                                                    myTarget.techEffect[arraySelect].effects[x].index1,
                                                                    resourceNames);
                                                            myTarget.techEffect[arraySelect].effects[x].amount =
                                                                EditorGUI.FloatField(
                                                                    new Rect(1000 * rect.x, curY * rect.y, 290 * rect.x,
                                                                        20 * rect.y), "",
                                                                    myTarget.techEffect[arraySelect].effects[x].amount);
                                                        }
                                                        else
                                ...
                                if (GUI.Button(new Rect(400 * rect.x, curY * rect.y, 273 * rect.x, 20 * rect.y),
                                    "Add"))
                                {
                                    ModifyBTE(myTarget.techEffect[arraySelect].effects.Length + 1,
                                        myTarget.techEffect[arraySelect].effects.Length, myTarget, arraySelect);
                                }
                                if (GUI.Button(new Rect(673 * rect.x, curY * rect.y, 272 * rect.x, 20 * rect.y),
                                    "Remove"))
