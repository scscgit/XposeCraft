...
- Use UIController Component
	1. Add UIController component to a GameObject
	2. UIController and Animator will be create
	3. Create new controller to use of the Animator (See "Create Controller" step)
- Create Controller
	1. In "Project" window > (Rigth click) > Create > Animator Override Controller
	2. Rename asset
	3. Click "Setup by UIController" on Inspector window
	4. Drag controller to UIController Animator "Controller" Variable
	5. Editor the UI animation on Animation window